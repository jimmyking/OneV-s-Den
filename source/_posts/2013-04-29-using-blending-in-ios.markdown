...
![使用kCGBlendModeDestinationIn模式的结果](http://img.onevcat.com/2013/blend_1.png)
...
![使用kCGBlendModeOverlay和kCGBlendModeDestinationIn模式的结果](http://img.onevcat.com/2013/blend_3.png)
